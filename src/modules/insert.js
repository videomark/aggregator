...
class Insert {
    ...
    async insertAggrDay(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${config.get('db.aggregation_collection_suffix.day')}`);

        const values = await srcCollection.aggregate([
            {
                '$match': {
                    '$and': [
                        { 'qoe': { '$gte': 0.0 } },
    ...
    async insertAggrHour(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
            config.get('db.aggregation_collection_suffix.hour')}`);
    ...
    async insertAggrServiceDay(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
            config.get('db.aggregation_collection_suffix.service')}_${config.get('db.aggregation_collection_suffix.day')}`);
    ...
    async insertAggrServiceHour(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
            config.get('db.aggregation_collection_suffix.service')}_${
            config.get('db.aggregation_collection_suffix.hour')}`);
    ...
    async insertAggrCountryDay(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
            config.get('db.aggregation_collection_suffix.country')}_${config.get('db.aggregation_collection_suffix.day')}`);
    ...
    async insertAggrCountryHour(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
            config.get('db.aggregation_collection_suffix.country')}_${
            config.get('db.aggregation_collection_suffix.hour')}`);
    ...
    async insertAggrSubdivisionDay(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
            config.get('db.aggregation_collection_suffix.subdivision')}_${config.get('db.aggregation_collection_suffix.day')}`);
    ...
    async insertAggrSubdivisionHour(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
            config.get('db.aggregation_collection_suffix.subdivision')}_${
            config.get('db.aggregation_collection_suffix.hour')}`);
    ...
    async insertAggrISPDay(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
            config.get('db.aggregation_collection_suffix.isp')}_${config.get('db.aggregation_collection_suffix.day')}`);
    ...
    async insertAggrISPHour(start, end) {
        ...
        const srcCollection = await this.wrapper.collection(this.options.sourceCollection);
        const dstCollection = await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
            config.get('db.aggregation_collection_suffix.isp')}_${
            config.get('db.aggregation_collection_suffix.hour')}`);
    ...
    async remove() {
        const collections = [];
        try {
            collections.push(await this.wrapper.collection(`${this.options.aggregationCollectionPrefix}${
                config.get('db.aggregation_collection_suffix.day')}`));
